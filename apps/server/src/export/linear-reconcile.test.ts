...
const source: LinearExport = {
  workspace: { id: "00000000-0000-4000-8000-000000000021", name: "W" },
  actors: [],
  teams: [
    {
      ...
      key: "AT",
      name: "AT",
      states: [{ id: "00000000-0000-4000-8000-000000000023", name: "Todo", type: "unstarted" }],
    },
  ],
  labels: [],
  projects: [],
  ...
  issues: [
    {
      ...
      stateId: "00000000-0000-4000-8000-000000000023",
      creatorId: "missing",
