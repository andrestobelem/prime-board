...
| `labels`          | `id, name, color, description?, teamId?, groupId?, archivedAt?`                                                                          | `teamId NULL` = label de workspace. Los grupos tienen un nivel, hasta 250 hijas y exclusividad por Issue; archivar conserva las referencias existentes.                                                                             |
