...
Criterio rector: prime-board es **API-first**. Un agente debe poder completar todo el flujo (crear, consultar, actualizar, comentar y reaccionar a cambios) sin usar la UI.
...
| Teams                            | Unidad de trabajo con clave corta (`AT`), estados y settings propios. | 🟢            | Los identificadores legibles salen de aquí; clave para que los agentes referencien trabajo.                                                       |
...
| Funcionalidad                                    | Descripción                                   | Clasificación | Nota para agentes                                                                                      |
| ------------------------------------------------ | --------------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------ |
| Filtrado potente                                 | Por cualquier propiedad, combinable (AND/OR). | 🟢            | La consulta programática es el caso de uso principal de un agente ("mis issues urgentes sin empezar"). |
...
2. **Semántica portable**: los tipos de estado (started, completed…), la escala fija de
   ...
   configuración previa — lo que un agente necesita.
