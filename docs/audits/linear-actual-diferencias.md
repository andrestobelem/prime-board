...
| Billing/SSO/SCIM       | Billing, planes, seguridad enterprise, SSO/SCIM y dominios aprobados.                                              | No existen; local-first y sin hosted auth.                                                                                                                                                                                                                          | **Fuera de alcance** (ADR-0021).                   | No incluir en PRB-411–420.                                               |
| Loops/Coding sessions  | Linear ofrece Loops y Coding sessions como superficies hospedadas.                                                 | No existen; el modelo local-first no las publica.                                                                                                                                                                                                                   | **Fuera de alcance** (ADR-0021).                   | Reabrir solo con un requisito de producto hospedado.                     |
