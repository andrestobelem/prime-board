...
- El migrador de PostgreSQL en `apps/server/src/db/postgres/migrator.ts` aplica nueve migraciones
  independientes (`0001` a `0009`). `0005` agrega Documents, `0006` agrega suscriptores, `0007`
