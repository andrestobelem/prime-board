...
elimina sin archivo. Los enlaces de artefactos externos de Linear siguen la conversión documentada.
...
- Documents locales no forman parte del producto vigente. La réplica conserva solo enlaces de artefactos externos de Linear y un archivo externo verificable para datos históricos.
