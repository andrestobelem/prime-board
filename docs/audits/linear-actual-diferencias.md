...
| Billing/SSO/SCIM       | Billing, planes, seguridad enterprise, SSO/SCIM y dominios aprobados.                                              | No existen; local-first y sin hosted auth.                                                                                                                                                                                                                          | **Fuera de alcance** (ver [ADR-0020](../adr/0020-billing-planes-y-uso-de-ai-fuera-del-modelo-local.md)). | No incluir en PRB-411–420.                                               |
