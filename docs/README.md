...
- [Billing, planes y uso de AI](adr/0021-billing-planes-y-uso-de-ai-fuera-del-modelo-local.md): fuera del modelo local hasta una decisión de servicio hospedado.
