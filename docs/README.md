...
- `guia-agentes.md` — cómo operar prime-board siendo un agente: GraphQL, CLI, MCP y webhooks (AT-143).
- `investigacion-tickets-en-repo.md` — cómo hacer del repo la fuente de verdad de los tickets (AT-153).
