...
- `relevamiento-linear.md` — inventario de funcionalidades de Linear.
- `alcance-mvp.md` — lista cerrada del MVP y decisiones estructurales.
- `specs/mvp.md` — especificación técnica del MVP.
